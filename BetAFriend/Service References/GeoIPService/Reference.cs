...
namespace BetAFriend.GeoIPService {
    ...
    public interface GeoIPServiceSoap {
        ...
        BetAFriend.GeoIPService.GeoIP GetGeoIP(string IPAddress);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.webservicex.net/GetGeoIP", ReplyAction="*")]
        System.Threading.Tasks.Task<BetAFriend.GeoIPService.GeoIP> GetGeoIPAsync(string IPAddress);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.webservicex.net/GetGeoIPContext", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        BetAFriend.GeoIPService.GeoIP GetGeoIPContext();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.webservicex.net/GetGeoIPContext", ReplyAction="*")]
        System.Threading.Tasks.Task<BetAFriend.GeoIPService.GeoIP> GetGeoIPContextAsync();
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface GeoIPServiceSoapChannel : BetAFriend.GeoIPService.GeoIPServiceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class GeoIPServiceSoapClient : System.ServiceModel.ClientBase<BetAFriend.GeoIPService.GeoIPServiceSoap>, BetAFriend.GeoIPService.GeoIPServiceSoap {
        ...
        public BetAFriend.GeoIPService.GeoIP GetGeoIP(string IPAddress) {
            return base.Channel.GetGeoIP(IPAddress);
        }
        
        public System.Threading.Tasks.Task<BetAFriend.GeoIPService.GeoIP> GetGeoIPAsync(string IPAddress) {
            return base.Channel.GetGeoIPAsync(IPAddress);
        }
        
        public BetAFriend.GeoIPService.GeoIP GetGeoIPContext() {
            return base.Channel.GetGeoIPContext();
        }
        
        public System.Threading.Tasks.Task<BetAFriend.GeoIPService.GeoIP> GetGeoIPContextAsync() {
